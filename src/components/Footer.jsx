...
import { FaClinicMedical, FaFacebookF, FaInstagram, FaTwitter, FaLinkedinIn, FaYoutube } from 'react-icons/fa'
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12'>
          <section className='lg:col-span-2'>
            ...
            <p className='text-gray-400 mb-6'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, neque eius dolorum dolor, provident voluptatibus nam quas iste dolorem debitis voluptate sit ipsa enim in, vero a similique ipsum quo!
            </p>
          ...
          <address>
            <h3 className='text-xl font-bold mb-6 relative pb-2 after:content-[""] after:absolute after:left-0 after:bottom-0 after:w-12 after:bg-pink-500'>
              Contact Us
            </h3>
