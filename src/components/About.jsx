...
const About = () => {
    const stats = [
        ...
        {value: "2.5+", label: "Happy Clients", icon: <FaAward className="text-pink-500" aria-hidden='true' />},
        {value: "15+", label: "Expert Docters", icon: <FaAward className="text-pink-500" aria-hidden='true' />},
        {value: "10+", label: "Treatments", icon: <FaAward className="text-pink-500" aria-hidden='true' />},
    ];
    const approachesItems = [
        {
            ...
            <div className="container mx-auto px-4">
             <article data-aos='fade-up' data-aos-delay='400' className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl w-full max-w-md mx-auto">
                    <img 
                    src={aboutImage}
                    className="w-full h-auto object-cover aspect-[4/5]" loading="lazy"/>
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" aria-hidden='true'></div>
                </div>

                <span className="hidden lg:block absolute -bottom-8 -left-8 w-32 h-32 rounded-full bg-pink-500 opacity-20 z-0" aria-hidden='true'></span>
                <span className="hidden lg:block absolute -top-8 -right-8 w-40 h-40 rounded-full bg-pink-500 opacity-20 z-0" aria-hidden='true'></span>
                ...
                <header>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                        About <span className="text-pink-600">Glamour Clinic</span></h2>
                        <p className="text-lg text-gray-600 mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, veritatis. Sapiente pariatur assumenda atque voluptatem voluptatibus eveniet molestias error doloremque aliquid explicabo possimus quisquam expedita accusantium facilis illo, commodi iste?</p>
                </header>
                <section className="m-8">
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">Our Approach</h3>
                    <ul className="space-y-3">
                        {approachesItems.map((item, index) => (
             ...
             <aside className="mt-20 bg-white rounded-2xl p-8 md:p-12 shadow-lg relative overflow-hidden">
                <span className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-pink-500 opacity-40" aria-hidden='true'></span>
                <div className="relative z-10">
                    <h3 className="text-2xl font-bold text-gray-800 mb-6">Our Mission</h3>
                    <blockquote className="text-lg text-gray-700 mb-6">
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, veritatis. Sapiente pariatur assumenda atque voluptatem voluptatibus eveniet molestias error doloremque aliquid explicabo possimus quisquam expedita accusantium facilis illo, commodi.""
                    </blockquote>
