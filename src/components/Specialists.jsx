...
import SpecialistsImg from '../assets/SpecialistsImg.jpg';
import SpecialistsImg1 from '../assets/SpecialistsImg1.jpg';
import SpecialistsImg2 from '../assets/SpecialistsImg2.jpg';
        ...
        <div className='container mx-auto px-4'>
            <header data-aos='fade-up' data-aos-delay='400' className='text-center mb-16 relative'>
                ...
                <p className='text-lg text-gray-600 max-w-2xl mx-auto relative z-10'>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus dignissimos earum modi? 
                </p>
                    ...
                    <li key={doctor.id} className='group relative'>
                        ...
                        <div className='p-6 relative -mt-10'>
                            <div className='bg-pink-50 rounded-lg shadow-md p-6'>
                                ...
                                <figure className='absolute -top-6 left-6 bg-pink-600 text-white p-3 rounded-full shadow-lg' aria-hidden='true'>
            ...
            <aside data-aos='fade-up' data-aos-delay='500' className='bg-gradient-to-r from-pink-100 to-purple-100 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden'>
                <span className='absolute -top-20 -left-20 w-40 h-40 rounded-full bg-pink-200 opacity-20' aria-hidden='true'></span>
                <span className='absolute -bottom-20 -right-20 w-60 h-60 rounded-full bg-pink-200 opacity-20' aria-hidden='true'></span>
